...
/***/ "../node_modules/focus-trap-js/src/index.js":
/*!**************************************************!*\
  !*** ../node_modules/focus-trap-js/src/index.js ***!
  \**************************************************/
...
/* WEBPACK VAR INJECTION */(function(process) {var candidateSelectors = [
  'input',
  'select',
  'textarea',
  'a[href]',
...
/* harmony import */ var focus_trap_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! focus-trap-js */ "../node_modules/focus-trap-js/src/index.js");
/* harmony import */ var focus_trap_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(focus_trap_js__WEBPACK_IMPORTED_MODULE_3__);
...
var textAbout = document.querySelector('.about__js');
...
var titleCatalog = document.querySelector('.catalog__wrapper h3');

var changeTitleName = function changeTitleName() {
...
var inputElement = document.querySelector('.feedback-form__phone input');
var popupElement = document.querySelector('.popup__phone input');
document.addEventListener('DOMContentLoaded', function () {
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(inputElement, maskOptions);
});
document.addEventListener('DOMContentLoaded', function () {
  var maskOptions = {
    mask: '+{7}(000)000-00-00'
  };
  Object(imask__WEBPACK_IMPORTED_MODULE_2__["default"])(popupElement, maskOptions);
}); //подвал
...
var navPlus = document.querySelector('.plus-nav');
var contactsPlus = document.querySelector('.plus-contacts');
...
var nameImput = document.querySelector('.popup__name input'); // let submitButton = document.querySelector('.popup__submit');
...
document.addEventListener('keydown', function (event) {
  focus_trap_js__WEBPACK_IMPORTED_MODULE_3___default()(event, popup);
});

var onSmallHeight = function onSmallHeight() {
